...
export const CMP_PROJECT_PACK = "component.project.pack.runner";
...
export const CMP_TRYIT_GRAPHQL_VIEW = "component.tryit.graphql.view";
...
export const CMP_BI_COPILOT_LOGIN = "component.bicopilot.login";